...
class PDF extends FPDF{
	...
	function Footer(){
		...
		$this->Cell(100,11,'Designed Twitter @jpablo_men',2,1,'L');
	}
...
$pdf->Image('golsgymsinfondo.png',1,1,-200);
...
$pdf->Text(32,188,'320 866 7780',0,1); 

//instagram
$pdf->Image('instagram2.png',20,195,-1300);
$pdf->Text(32,203,'@juanpablo_men',0,1); 

//ubicacion
$pdf->Image('google.png',10,198,-400);
$pdf->Text(32,220,'Transversal 18D #20B-43 Las Delicias',0,1); 
